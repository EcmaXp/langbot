...
kubectl --context sigsrv-prod -n langbot rollout restart deployment langbot-openai-o3
kubectl --context sigsrv-prod -n langbot rollout restart deployment langbot-openai-o4-mini
